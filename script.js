let app = new Vue({
    ...
    data: {
        questions: [{
            ...
            answer: "Pierce Ong Ming Ern", localscore: 0, isincorrect: true
        },
        {
            question: "What year is Pierce born in?",
            answers: ["1999", "1998", "2077", "1997"], answer: "1999", localscore: 0, isincorrect: true
        },
        {
            question: "What does Pierce study in college?",
            answers: ["Arts", "Computer Science", "Rocket Science", "Accounting & Finance"],
            answer: "Accounting & Finance", localscore: 0, isincorrect: true
        },
        {
            question: "Is Pierce a vanilla or chocolate guy?",
            answers: ["Chocolate ftw!!", "Nah it's gotta be vanilla"], answer: "Nah it's gotta be vanilla", localscore: 0, isincorrect: true
        }, {
            question: "What is Pierce's favorite sport?",
            answers: ["Football", "Badminton", "Coding", "Basketball"], answer: "Badminton", localscore: 0, isincorrect: true
        }
        ],
        current: 0
        , models: [1],
